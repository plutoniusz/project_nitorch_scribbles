...
%     K = 10;
    ...
    x = load([main_path '/fsl-probtrackx-2/fdt_matrix2.dot']);
...
for i=1:K
    ...
    %~,~,j] = unique(idx);
    mask(ind) = R(i, :);
    save_avw(mask, ['/data/underworld/kbas/03_data/derivatives/112111/20191115/dwi/fsl-probtrackx-2/clusters_test_single2_' num2str(i)] ,'i',scales);
end
