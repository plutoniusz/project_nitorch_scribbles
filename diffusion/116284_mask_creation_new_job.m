%-----------------------------------------------------------------------
% Job saved on 30-Oct-2022 20:01:00 by cfg_util (rev $Rev: 8183 $)
% spm SPM - SPM12 (12.6)
...
matlabbatch{5}.cfg_basicio.file_dir.file_ops.cfg_file_split.index = {1};
matlabbatch{6}.spm.tools.mb.fil.images(1) = cfg_dep('File Set Split: quantitative space registered (1)', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{1}));
