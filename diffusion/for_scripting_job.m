%-----------------------------------------------------------------------
% Job saved on 10-Mar-2023 21:23:32 by cfg_util (rev $Rev: 8183 $)
% spm SPM - SPM12 (12.6)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_named_dir.name = 'subject_folder';
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_named_dir.dirs = {{'/data/underworld/home/kbas/03_data/source_dif/mri/112111'}};
...
matlabbatch{4}.cfg_basicio.file_dir.dir_ops.cfg_named_dir.dirs = {{'/data/underworld/home/kbas/03_data/raw_dif/112111/20191115/anat/Results/Supplementary'}};
...
matlabbatch{16}.cfg_basicio.file_dir.dir_ops.cfg_named_dir.dirs = {{'/data/underworld/home/kbas/03_data/processed_dif/112111'}};
