%-----------------------------------------------------------------------
% Job saved on 18-Nov-2022 17:08:32 by cfg_util (rev $Rev: 8183 $)
% spm SPM - SPM12 (12.6)
...
matlabbatch{5}.cfg_basicio.file_dir.file_ops.cfg_file_split.name = 'quantitative space registered';
...
matlabbatch{6}.spm.tools.mb.fil.images(1) = cfg_dep('File Set Split: quantitative_space_split (1)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('{}',{1}));
...
matlabbatch{7}.spm.spatial.coreg.write.source(1) = cfg_dep('Image Labelling: Labelled brains', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','labels', '()',{':'}));
...
matlabbatch{8}.spm.util.imcalc.outdir = {'/data/underworld/home/kbas/03_data/source/mri/112111/20191115/10/modified'};
...
matlabbatch{9}.cfg_basicio.file_dir.file_ops.cfg_gzip_files.files(1) = cfg_dep('Image Calculator: ImCalc Computed Image: amygdala_resliced', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{9}.cfg_basicio.file_dir.file_ops.cfg_gzip_files.outdir = {''};
matlabbatch{9}.cfg_basicio.file_dir.file_ops.cfg_gzip_files.keep = true;
