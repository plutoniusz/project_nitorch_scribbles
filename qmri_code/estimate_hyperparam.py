...
penalties = [dict(pd=10, r1=10, mt=10, r2s=10), dict(pd=1, r1=1, mt=1, r2s=1), dict(pd=10, r1=1, mt=1, r2s=1), dict(pd=1, r1=10, mt=1, r2s=1), dict(pd=1, r1=1, mt=10, r2s=1), dict(pd=1, r1=1, mt=1, r2s=10)]
